package uz.abubakir_khakimov.pubtrans_finder.provider.local.database.features.locations.di.bind
...
import uz.abubakir_khakimov.pubtrans_finder.provider.local.database.features.locations.sources.LocationsLocalDataSourceImpl
